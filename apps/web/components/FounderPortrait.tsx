...
// The owner can add this PNG without changing the component.
export function FounderPortrait({ name, label, src = "/about/vladyslav-titov.png" }: { name: string; label: string; src?: string }) {
